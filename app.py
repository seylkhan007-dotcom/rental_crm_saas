...
from ui.money_distribution_page import render_money_distribution_page
...
menu_options = [
    ...
    ("📤 Выплаты", "Выплаты"),
    ("💸 Распределение денег", "Распределение денег"),
...
elif page == "Распределение денег":
    render_money_distribution_page(conn)
